        ...
        <form id="editUserForm">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="email" name="year_level" required>
            </div>

            <div class="form-group">
              <label for="course">Course</label>
              <input type="text" class="form-control" id="password" name="course">
            </div>  

               <div class="form-group">
              <label for="section">Section</label>
              <input type="text" class="form-control" id="password" name="section">
            </div>  
...
<script src="<?= base_url('js/records/records.js') ?>"></script>
<?= $this->endSection() ?>
